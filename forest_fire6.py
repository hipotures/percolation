...
class ForestFireSimulationGPU:
    ...
    def run_simulation(self):
        ...
        while not self.simulation_finished:
            self.process_epoch()
        return self.current_epochs.get()
