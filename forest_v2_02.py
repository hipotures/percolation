...
class ForestFire:
    def __init__(self):
        self.size = 200  # Grid size (100x100). Możesz zwiększyć do 1000x1000, ale pamiętaj o wydajności.
        self.probability = 0.60  # Probability of a cell being a tree
        self.cell_size = 2  # Size of each cell in pixels for better visibility
