...
class ForestFire:
    ...
    def reset_forest(self):
        ...
        if self.simulation_thread and self.simulation_thread.is_alive():
            print("Interrupting current simulation...")
            self.stop_event.set()
                ...
                if event.type == pygame.QUIT:
                    ...
                    if event.key == pygame.K_ESCAPE:
                        ...
                        if self.simulation_thread is None or not self.simulation_thread.is_alive():
                            ...
                            print("Simulation is already running. Press '0' to reset.")

            if self.simulation_thread is not None and self.simulation_thread.is_alive():
                # Update display regularly while simulation is running
                self.display_forest()
...
if __name__ == "__main__":
    game = ForestFire(min_burned_fraction=0.001, csv_filename_prefix='cluster_statistics')  # 1% threshold
    game.run()
