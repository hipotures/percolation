...
class ForestFire:
    def __init__(self, min_burned_fraction=0.01, csv_filename_prefix='cluster_statistics'):
        ...
        self.simulation_points = copy.deepcopy(self.tree_positions) if hasattr(self, 'tree_positions') else []
    ...
    def run_simulations(self):
        ...
        for idx in range(self.simulation_index, total_trees):
            ...
            # Process Pygame events to allow for interruption/reset
            pygame.event.pump()
