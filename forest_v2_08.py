...
class ForestFire:
    def __init__(self, min_burned_fraction=0.01, csv_filename='cluster_statistics.csv'):
        ...
        self.csv_filename = csv_filename  # Filename for CSV statistics
    ...
    def write_statistics_to_csv(self):
        ...
        with open(self.csv_filename, mode='w', newline='') as csv_file:
            ...
            csv_writer.writerow(['Cluster Size', 'Number of Clusters'])
            for size, count in sorted_sizes:
                csv_writer.writerow([size, count])

        print(f"Cluster statistics written to {self.csv_filename}")
    ...
    def run(self):
        ...
        while running:
            ...
            if not simulation_done:
                # Continually display the forest until simulation starts
...
if __name__ == "__main__":
    game = ForestFire(min_burned_fraction=0.001, csv_filename='cluster_statistics.csv')  # 1% threshold
    game.run()
